  ...
  return (
    <div className="grid gap-2">
      ...
      <select
        ...
        className="min-h-12 w-full rounded-[14px] border border-white/10 bg-[#111723] px-4 py-3 text-white outline-none transition disabled:cursor-not-allowed disabled:border-white/[0.06] disabled:text-white/30 focus:border-blue-300/55 focus-visible:ring-2 focus-visible:ring-blue-300/50"
      >
