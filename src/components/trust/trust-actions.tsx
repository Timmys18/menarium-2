      ...
      <ConfirmDialog
        ...
        description={
          blocked
            ...
            : "Ожидающие предложения отменятся, а новые чаты по объявлениям и обмены будут недоступны. Чат уже принятого обмена останется открыт, чтобы вы могли безопасно его завершить."
        }
