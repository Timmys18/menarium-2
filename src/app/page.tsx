    ...
    <AppShell>
      ...
      <div className={`min-h-screen px-4 pb-28 sm:px-6 md:pb-32 md:pt-28 ${preview ? "pt-36" : "pt-24"}`}>
        ...
        */}
              ...
              <div className="relative flex flex-col gap-4">
                {heroPair.map((item, index) => (
                  <Link
                    key={item.id}
                    href={`/item/${item.id}`}
                    className={`w-[82%] max-w-sm overflow-hidden rounded-card border border-white/10 bg-[var(--surface-raised)] shadow-[0_24px_70px_rgba(0,0,0,0.42)] transition hover:z-30 hover:-translate-y-1 focus-visible:z-30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus-ring)] ${
        ...
        <section className="mx-auto mt-28 max-w-7xl border-t border-white/8 pt-20 md:mt-36 md:pt-24">
              ...
              {[
                ...
                return (
                  <SurfaceCard key={step.number} className="relative overflow-hidden p-6">
                    <div className="flex h-11 w-11 items-center justify-center rounded-control border border-white/10 bg-white/[0.05] text-teal-200">
