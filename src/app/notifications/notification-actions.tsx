  ...
  return (
    <div className="flex flex-col items-end gap-1">
      <button
        ...
        className="rounded-xl px-3 py-2 text-xs text-teal-200 transition-colors hover:bg-teal-300/[0.08] hover:text-teal-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-300/60 disabled:opacity-50"
      >
