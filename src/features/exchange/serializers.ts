...
export function serializeSwap(swap: SwapWithItems) {
  return {
    ...
    handoffMode: swap.handoffMode,
    handoffScheduledAt: swap.handoffScheduledAt?.toISOString() ?? null,
    handoffDetails: swap.handoffDetails,
    handoffRevision: swap.handoffRevision,
    senderHandoffConfirmed: swap.senderHandoffConfirmed,
    receiverHandoffConfirmed: swap.receiverHandoffConfirmed,
